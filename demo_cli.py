...
def generate_audio(fpath,input_text):
    ## Info & args
    print(fpath)
    if fpath!="" and input_text!="":
        ...
        try:
            ...
            message = "Reference voice: enter an audio filepath of a voice to be cloned (mp3, " \
                      "wav, m4a, flac, ...):\n"
            in_fpath = Path(fpath.replace("\"", "").replace("\'", ""))
            ...
            num_generated += 1
            print("\nSaved output as %s\n\n" % filename)
            messagebox.showinfo("showinfo", ("Audio generated Successfully as saved as "+filename))
        ...
        messagebox.showinfo("showinfo", ("File path or Input text not given"))